...
public class RollerCoaster {
	...
	public static void main (String[] args) {
		...
		if(heightInt > 42 ){ 
			JOptionPane.showMessageDialog(null, "Ya, you can ride it, no ones going to ever look at this :*( ");	
			
			}
		else {	
			JOptionPane.showMessageDialog(null, ":(, you can't ride it, no ones going to ever look at this :*( ");
		}
	}
